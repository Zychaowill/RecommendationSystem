...
<html>
  <head>
	...
	.picture .rotatesimg{
		...
		cursor:pointer;
		background-image:url("realtimeData_TV/img/p0.png");
	...
	@-webkit-keyframes transform-5 { 
		from{-webkit-transform:perspective(2000px) rotateY(180deg);transform:perspective(2000px) rotateY(180deg);} 
	    to{-webkit-transform:perspective(2000px) rotateY(0deg);transform:perspective(2000px) rotateY(0deg);} 
	}
  ...
  <body>
  	<div class="stars"></div>
  	<div class="content marginLeft marginTop">
  		<a href="pages/stream/streaming.jsp" target="_blank">
  			<img src="pages/images/streaming.png" width="320px" height="180px" alt="流式计算框架-Spark Streaming" />
  		</a>
  	</div>
  	<div class="content marginTop">
  		<a href="pages/memory/memory.jsp" target="_blank">
  			<img src="pages/images/memory.png" width="320px" height="180px" alt="内存计算框架-Spark Core" />
  		</a>
  	</div>
  	<div class="content marginTop">
  		<a href="pages/learning/learning.jsp" target="_blank">
  			<img src="pages/images/learning.png" width="320px" height="180px" alt="机器学习-Spark MlLib" />
  		</a>
  	</div>
  	<script type="text/javascript">
  	var width = $(window).width();
  	var height = $(window).height();
  	var marginLeft = (width - (320 * 3) + (36 * 2)) / 3;
  	var marginTop = (height - (180 * 2) + 30) / 2;
  	$(".marginLeft").css("marginLeft",marginLeft);
